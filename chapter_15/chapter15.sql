...
CREATE
OR REPLACE VIEW employee_tax_dept AS
SELECT
    emp_id,
    first_name,
    last_name,
...
INSERT INTO
    employee_tax_dept (first_name, last_name, dept_id)
VALUES
    ('Suzanne', 'Legere', 1);
...
CREATE
OR REPLACE FUNCTION update_personal_days()
RETURNS void AS $$
BEGIN
    UPDATE teachers
    SET personal_days =
